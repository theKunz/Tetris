 ...
 * @author Aaron
 */
public class TetriminoBL extends Tetrimino {
    
    public TetriminoBL() {
        blocksX[0] = new SimpleIntegerProperty(6);
    ...
    static Background background = new Background(new BackgroundImage(new Image("/BlueBlock.png", false), BackgroundRepeat.REPEAT, 
